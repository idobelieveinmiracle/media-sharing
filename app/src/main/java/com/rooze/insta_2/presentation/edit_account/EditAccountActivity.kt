...
import com.rooze.insta_2.presentation.MainActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.backButton.setOnClickListener {
            setResult(
                RESULT_OK,
                Intent().apply {
                    putExtra(ViewConstants.EXTRA_RELOAD_ACCOUNT, viewModel.edited)
                    putExtra(ViewConstants.EXTRA_RELOAD_POSTS, viewModel.edited)
                }
            )
            finish()
        }
